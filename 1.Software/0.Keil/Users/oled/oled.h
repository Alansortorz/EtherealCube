...
#define  GPIO_OLED_SCLK_Pin     GPIO_Pin_13							/* D0 */
#define  GPIO_OLED_PIN_Pin     	GPIO_Pin_15							/* D1 */
#define  GPIO_OLED_RES_Pin     	GPIO_Pin_14							/* RES */
#define  GPIO_OLED_DC_Pin     	GPIO_Pin_12							/* DC */
...
#define OLED_RST_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_14)	//RES RES => 接RES引脚
#define OLED_RST_Set() GPIO_SetBits(GPIOB,GPIO_Pin_14)

#define OLED_DC_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_12)	//DC  DC  => 接DC引脚 
#define OLED_DC_Set() GPIO_SetBits(GPIOB,GPIO_Pin_12)

/* 使用4线串行接口时使用 */ 
#define OLED_SCLK_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_13)//CLK D0  => 接D0引脚
#define OLED_SCLK_Set() GPIO_SetBits(GPIOB,GPIO_Pin_13)

#define OLED_SDIN_Clr() GPIO_ResetBits(GPIOB,GPIO_Pin_15)//PIN D1  => 接D1引脚
